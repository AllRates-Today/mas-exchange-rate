// Monetary Authority of Singapore exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/mas';
...
/** Latest rate for one pair, e.g. getRate('USD', 'SGD', { apiKey }). */
